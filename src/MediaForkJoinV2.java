...
public class MediaForkJoinV2 extends RecursiveTask<Double>
{
    ...
    MediaForkJoinV2(short[] p_Vector, int p_Inicio, int p_Fin)
    {
    ...
    private Double getHalfRec()
    {
        ...
        MediaForkJoinV2 l_Tarea1 = new MediaForkJoinV2(a_Vector, a_Inicio, l_Medio);
        MediaForkJoinV2 l_Tarea2 = new MediaForkJoinV2(a_Vector, l_Medio, a_Fin);
    ...
    public static void main(String[] args)
    {
        ...
        MediaForkJoinV2 l_Tarea = new MediaForkJoinV2();
        ...
        l_Tarea = new MediaForkJoinV2(l_Data, l_Inicio, l_Fin);
